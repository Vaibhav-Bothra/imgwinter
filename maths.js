...
function bar() {
    ...
    let val = a.value
    let arr = ["Trigonometry", "Algebra", "Straight Lines", "Circles", "Conic Sections", "Arithmetic Progression"]
    if (a.value == "") {
        b.innerHTML = ""
...
<body>
   ...
   <br><br><br><br><br>
    ...
    <form action="/que_trigo" method="post">
...
function runvect() {
    let scode1 = scode.replace(`<form action="/que_trigo" method="post">`, `<form action="/que_lines" method="post">`)
    document.body.innerHTML = scode1;
}

function runalgeb() {
    let scode2 = scode.replace(`<form action="/que_trigo" method="post">`, `<form action="/que_algebra" method="post">`)
