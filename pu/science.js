...
function bar(){
    ...
    let val=a.value
    let arr=["Biology","General Physics","Chemistry","Electrostatics","EVS","Quantum"]
    if (a.value=="") {
        b.innerHTML=""
...
s5.addEventListener('click',runcoord);
s6.addEventListener('click',rungeom);

s1.addEventListener('click',runtrig);
s2.addEventListener('click',run1);
s3.addEventListener('click',run1);
...
<body>
   ...
   <br><br><br><br><br>
    ...
    <form action="/que_bio" method="post">
...
function runcoord(){
let scode1=scode.replace(`<form action="/que_bio" method="post">`,`<form action="/que_chem" method="post">`)
document.body.innerHTML=scode1;
}

function rungeom(){
  let scode2=scode.replace(`<form action="/que_bio" method="post">`,`<form action="/que_genphy" method="post">`)
